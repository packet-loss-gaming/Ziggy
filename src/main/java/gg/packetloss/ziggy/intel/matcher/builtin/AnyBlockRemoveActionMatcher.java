...
public class AnyBlockRemoveActionMatcher extends AbstractBlockRemoveMatcher {
    @Override
    ...
    @Override
    public int getGlobalTrustGraceLevel() {
        return 500;
    }

    @Override
    public int getGlobalTrustGraceAdjustment() {
        return 0;
    }
